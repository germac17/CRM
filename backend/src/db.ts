...
const DEFAULT_PLANS = [
  ...
  { id: "starter", name: "Старт", slug: "starter", price_monthly: 990, price_yearly: 9504, limit_vacancies: 15, limit_candidates: 300, ai_matching_enabled: true, limit_users: 3, priority_support: false, integrations_allowed: [], hidden: false },
  { id: "pro", name: "Про", slug: "pro", price_monthly: 3990, price_yearly: 38270, limit_vacancies: -1, limit_candidates: 2000, ai_matching_enabled: true, limit_users: 10, priority_support: true, integrations_allowed: [], hidden: false }
];
